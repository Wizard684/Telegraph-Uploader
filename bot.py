...
async def home(client, message):
  buttons = [[
    ...
    [
        InlineKeyboardButton('🔘Our Channel🔘', url='http://telegram.me/Mega_Bots_Updates'),
        InlineKeyboardButton('♥️Support♥️', url='https://t.me/Mega_Bots_Supporters')
    ]]
...
Made With Love By @Mega_Bots_Updates</b>""",
